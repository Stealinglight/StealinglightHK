...
export const videoProjects: VideoProject[] = [
  ...
  },
  {
    ...
    category: 'Commercial',
    description: 'Washing machine commercial directed by Olivier Hero Dressen, camera operation by Chris McMillon for Douyin (TikTok)',
    duration: '1:01',
  ...
  },
  {
    ...
    title: 'The Fighter',
    category: 'Documentary',
    description: 'A narrative documentary following boxer Thun Visuttirattanaporn, shot in Phuket,Thailand',
    duration: '5:32',
  ...
  },
  {
    ...
    title: 'CMPC 2019',
    category: 'Event',
    description: 'Promotional video for CMPC 2019 event, CMPC (Compañía Manufacturera de Papeles y Cartones) is a pulp and paper company in Santiago de Chile',
    duration: '6:59',
  ...
  },
  {
    ...
    category: 'Commercial',
    description: 'Product launch video for NIU electric scooters NGT and M+ models (European Market)',
    duration: '3:04',
