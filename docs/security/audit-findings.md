...
| Action                                | Pin Level  |
| ------------------------------------- | ---------- |
| actions/checkout                      | v6 (major) |
| actions/setup-node                    | v6 (major) |
| actions/cache                         | v5 (major) |
| actions/upload-artifact               | v7 (major) |
| github/codeql-action/\*               | v4 (major) |
| aws-actions/configure-aws-credentials | v6 (major) |
